  ...
  <div class="my-container">
    ...
    <div v-if="user" class="header user-info">
      <div class="base-info">
        ...
        <div class="right">
          <!-- @click="$router.push('/user-profile')" 跳转路由 -->
          <van-button size="mini" round :to="{ name: 'user-profile' }">编辑资料</van-button>
        </div>
      </div>
  ...
  methods: {
    async loadUserInfo() {
      try {
        ...
        console.log('ref:', ref);
        this.userInfo = ref.data.data  //赋值
      } catch (err) {
        console.log(err)
