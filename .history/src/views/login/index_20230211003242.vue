  ...
  <div class="login-container">
    ...
    <van-form @submit="onSubmit" ref="loginFormRef">
      ...
      >
        ...
        <template #right-icon>
          <van-count-down v-if="isCountDown" format="ss 秒" :time="5 * 1000" @finish="isCountDown = false" />       
          <van-button v-else class="send-sms-btn" round type="primary" @click="onSendSms">发送验证码</van-button>
        </template>
      </van-field>
